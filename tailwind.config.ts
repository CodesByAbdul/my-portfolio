...
import tailwindcssAnimatePlugin, { default as tailwindcssAnimate } from "tailwindcss-animate";
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "hero-gradient": "linear-gradient(135deg, #FF5E5B 0%, #8F3985 50%, #39A0ED 100%)",
        "card-gradient":
